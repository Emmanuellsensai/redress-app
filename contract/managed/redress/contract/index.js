...
const _descriptor_0 = new __compactRuntime.CompactTypeBytes(512);
...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      register_platform: (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('register_platform',
                                     ...
                                     'redress.compact line 47 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        ...
        const partialProofData = {
          input: {
            value: _descriptor_1.toValue(new_public_key_0),
      ...
      submit_claim: (...args_1) => {
        if (args_1.length !== 3) {
          throw new __compactRuntime.CompactError(`submit_claim: expected 3 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const encrypted_evidence_0 = args_1[1];
        const evidence_plaintext_0 = args_1[2];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('submit_claim',
                                     'argument 1 (as invoked from Typescript)',
                                     'redress.compact line 55 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(encrypted_evidence_0.buffer instanceof ArrayBuffer && encrypted_evidence_0.BYTES_PER_ELEMENT === 1 && encrypted_evidence_0.length === 512)) {
          __compactRuntime.typeError('submit_claim',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'redress.compact line 55 char 1',
                                     'Bytes<512>',
                                     encrypted_evidence_0)
        }
        if (!(evidence_plaintext_0.buffer instanceof ArrayBuffer && evidence_plaintext_0.BYTES_PER_ELEMENT === 1 && evidence_plaintext_0.length === 256)) {
          __compactRuntime.typeError('submit_claim',
                                     'argument 2 (argument 3 as invoked from Typescript)',
                                     'redress.compact line 55 char 1',
                                     'Bytes<256>',
                                     evidence_plaintext_0)
        }
        const context = { ...contextOrig_0, gasCost: __compactRuntime.emptyRunningCost() };
        const partialProofData = {
          input: {
            value: _descriptor_0.toValue(encrypted_evidence_0).concat(_descriptor_3.toValue(evidence_plaintext_0)),
        ...
        const result_0 = this._submit_claim_0(context,
                                              partialProofData,
                                              encrypted_evidence_0,
                                              evidence_plaintext_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      post_verdict: (...args_1) => {
        if (args_1.length !== 2) {
          throw new __compactRuntime.CompactError(`post_verdict: expected 2 arguments (as invoked from Typescript), received ${args_1.length}`);
        }
        const contextOrig_0 = args_1[0];
        const verdict_text_0 = args_1[1];
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.currentQueryContext != undefined)) {
          __compactRuntime.typeError('post_verdict',
                                     'argument 1 (as invoked from Typescript)',
                                     'redress.compact line 68 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(verdict_text_0.buffer instanceof ArrayBuffer && verdict_text_0.BYTES_PER_ELEMENT === 1 && verdict_text_0.length === 256)) {
          __compactRuntime.typeError('post_verdict',
                                     'argument 1 (argument 2 as invoked from Typescript)',
                                     'redress.compact line 68 char 1',
                                     'Bytes<256>',
        ...
        const partialProofData = {
          input: {
            value: _descriptor_3.toValue(verdict_text_0),
  ...
  _register_platform_0(context, partialProofData, new_public_key_0) {
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(1n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(new_public_key_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
  ...
  _submit_claim_0(context,
                  partialProofData,
                  encrypted_evidence_0,
                  evidence_plaintext_0)
  {
    const evidence_hash_0 = this._persistentHash_0(evidence_plaintext_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { idx: { cached: false,
                                       ...
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newArray()
                                                          .arrayPush(__compactRuntime.StateValue.newCell({ value: _descriptor_0.toValue(encrypted_evidence_0),
                                      ...
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(4n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(evidence_hash_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
  ...
  _post_verdict_0(context, partialProofData, verdict_text_0) {
    const verdict_hash_0 = this._persistentHash_0(verdict_text_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
                                       { push: { storage: false,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_10.toValue(5n),
                                                                                              alignment: _descriptor_10.alignment() }).encode() } },
                                       { push: { storage: true,
                                                 value: __compactRuntime.StateValue.newCell({ value: _descriptor_1.toValue(verdict_hash_0),
                                                                                              alignment: _descriptor_1.alignment() }).encode() } },
                                       { ins: { cached: false, n: 1 } }]);
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                                                          ...
                                                                          { push: { storage: false,
                                                                                    value: __compactRuntime.StateValue.newCell(__compactRuntime.alignedConcat(
                                                                                                                                 { value: _descriptor_10.toValue(0n),
                                                                                                                                   alignment: _descriptor_10.alignment() },
                                                                                                                                 { value: _descriptor_0.toValue(new Uint8Array(512)),
